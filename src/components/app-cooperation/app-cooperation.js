  ...
  const styleSpanTxt = {
    ...
    return(
        <div className="cooperation-block" id='coop'>
            ...
            <p>Если у Вас есть пожелания или Вы хотите предложить землю для размещения модульных складов, пожалуйста, свяжитесь с нами по телефону: <span style={styleSpanTxt}>+7 985 150 06 06.</span></p> <br />
